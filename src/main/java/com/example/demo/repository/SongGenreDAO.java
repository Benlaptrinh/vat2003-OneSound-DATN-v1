...
// import com.datn.entity.SongGenre;
...
// @Query("select sg from SongGenre sg where sg.song.id = :songId and
// sg.genre.id = :genreId")
// List<SongGenre> findSongGenresBySongIdandGenreId(@Param("songId") Long
// songId, @Param("genreId") Long genreId);
// }
